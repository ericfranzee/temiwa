...
;// CONCATENATED MODULE: ./config/global.ts
const BASE_URL = "https://api.temiwa.com/api/";
const DEFAULT_TOKEN_TYPE = (/* unused pure expression or super */ null && ("Bearer"));
const envLocation = process.env.NEXT_PUBLIC_DEFAULT_LOCATION?.split(",");
const defaultLocation = envLocation ? {
    lat: Number(envLocation[0]),
    lng: Number(envLocation[1])
} : {
    lat: 9.064477,
    lng: 7.486209
};
const activeOrderStatuses = (/* unused pure expression or super */ null && ([
    "new",
    "accepted",
    "ready",
    "on_a_way"
]));
const finishedOrderStatuses = (/* unused pure expression or super */ null && ([
    "delivered",
    "canceled"
]));
const redirectNotificationTypesMap = {
    order: "orders",
    parcelorder: "parcels",
    blog: "news",
    booking: "bookings"
};
const externalPayments = (/* unused pure expression or super */ null && ([
    "stripe",
    "razorpay",
    "paystack",
    "mollie",
...
const internalPayments = (/* unused pure expression or super */ null && ([
    "cash",
    "wallet"
]));
const storyTiming = 10;
const cardColors = (/* unused pure expression or super */ null && ([
    "#B9CCDF80",
    "#E3CDE180"
]));
const service1 = "#FFEDD7";
const service2 = "#D6FFD2";
const service3 = "#F1D2D2";
const service4 = "#D8DCFF";
const service5 = "#F7D8FF";
const service6 = "#C3F8FF";
const service7 = "#E8E8E8";
const service8 = "#FFE6B4";
const service9 = "#FFD2E8";
const service10 = "#C6F4E4";
const service11 = "#C1E8FF";
const service12 = "#C2B6A4";
const serviceColors = [
    service1,
    service2,
    service3,
...
const serviceBgs = (/* unused pure expression or super */ null && ([
    "/img/service1.png",
    "/img/service2.png",
    "/img/service3.png",
    "/img/service4.png",
...
const weekDays = (/* unused pure expression or super */ null && ([
    "sunday",
    "monday",
    "tuesday",
    "wednesday",
...
const googleCalendarEventCreateUrl = "https://calendar.google.com/calendar/u/0/r/eventedit";
const tipPercentages = (/* unused pure expression or super */ null && ([
    5,
    10,
    15,
    20,
...
const tipFor = (/* unused pure expression or super */ null && ([
    "system",
    "driver"
]));
...
;// CONCATENATED MODULE: ./utils/network-error.ts
...
var with_selector = __webpack_require__(302);
...
;// CONCATENATED MODULE: ./global-store/user.ts
...
const userActionOutsideOfComponent = useUserStore.setState;
/* harmony default export */ const user = ((/* unused pure expression or super */ null && (useUserStore)));

;// CONCATENATED MODULE: ./lib/fetcher.ts
...
const fetcher = async (input, init)=>{
    ...
    const res = await fetch(url, {
        ...init,
        headers: {
            Authorization: (0,lib/* getCookie */.ej)("token"),
            ...init?.headers
        }
    });
    if (!res.ok) {
        ...
        if (res.status === 401) {
            userActionOutsideOfComponent({
                user: null
            });
            (0,lib/* deleteCookie */.kT)("token");
            return redirect_redirect("/");
        }
...
/* harmony default export */ const lib_fetcher = (fetcher);
fetcher.post = async (input, init)=>fetcher(input, {
        ...init,
        method: "POST",
...
fetcher.put = async (input, init)=>fetcher(input, {
        ...init,
        method: "PUT",
        body: JSON.stringify(init?.body),
        headers: {
...
fetcher.delete = async (input, init)=>fetcher(input, {
        ...init,
        method: "DELETE",
        headers: {
            "Content-Type": "application/json"
...
;// CONCATENATED MODULE: ./utils/parse-settings.ts
const parseSettings = (settings)=>settings ? Object.assign({}, ...settings.map((setting)=>({
...
const getSettings = async ()=>{
    try {
        const settings = await lib_fetcher("v1/rest/settings", {
            cache: "no-cache"
        });
...
const middleware = async (request)=>{
    ...
    const uiType = [
        ...
        "3",
        "4"
    ].find((type)=>type === settings?.ui_type);
    if (!!uiType && pathname === "/") {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2Fhome%2Fuser%2Ftemiwa&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFhcGl8X25leHRcXC9zdGF0aWN8X25leHRcXC9pbWFnZXxhc3NldHN8ZmF2aWNvbi5pY298c3cuanMpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxhc3NldHN8ZmF2aWNvbi5pY298c3cuanMpLiopIn1d&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLygoPyFhcGl8X25leHRcXC9zdGF0aWN8X25leHRcXC9pbWFnZXxhc3NldHN8ZmF2aWNvbi5pY298c3cuanMpLiopKSguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii8oKD8hYXBpfF9uZXh0L3N0YXRpY3xfbmV4dC9pbWFnZXxhc3NldHN8ZmF2aWNvbi5pY298c3cuanMpLiopIn1dfQ%3D%3D!
...
__webpack_unused_export__ = exports.h2 = __webpack_unused_export__ = exports.kT = __webpack_unused_export__ = exports.d8 = exports.ej = exports.$1 = void 0;
var cookie_1 = __webpack_require__(868);
 ...
 */ var setCookies = function(key, data, options) {
    ...
    return (0, exports.d8)(key, data, options);
};
__webpack_unused_export__ = setCookies;
var deleteCookie = function(key, options) {
    return (0, exports.d8)(key, "", __assign(__assign({}, options), {
        maxAge: -1
    }));
};
exports.kT = deleteCookie;
/**
 ...
 */ var removeCookies = function(key, options) {
    ...
    return (0, exports.kT)(key, options);
};
__webpack_unused_export__ = removeCookies;
var hasCookie = function(key, options) {
    if (!key) return false;
    var cookie = (0, exports.$1)(options);
    return cookie.hasOwnProperty(key);
};
exports.h2 = hasCookie;
/**
 ...
 */ var checkCookies = function(key, options) {
    ...
    return (0, exports.h2)(key, options);
};
__webpack_unused_export__ = checkCookies;
 ...
 * LICENSE file in the root directory of this source tree.
 */ 
var h = __webpack_require__(211), n = __webpack_require__(785);
function p(a, b) {
    return a === b && (0 !== a || 1 / a === 1 / b) || a !== a && b !== b;
}
